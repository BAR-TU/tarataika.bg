    ...
    <main>
            ...
            <section>
                    <form action="">
                        ...
                        <label   for="elWindows" id="electricWindowslabel">Eл. стъкла</label>
                        ...
                        <input   type="text" id="infoholder" name="info" onChange={ getInfo } style={{height: "200px", width: "200px", textAlign: "left", textOverflow: "scroll"}}></input>
